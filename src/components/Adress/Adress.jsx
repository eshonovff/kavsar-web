...
const Address = () => {
  ...
  useEffect(() => {
    const setupOverlay = () => {
      ...
      // Создаем новый оверлей, который будет содержать маркер
      ...
      // Добавляем оверлей в контейнер карты
  ...
  // Функция для открытия маршрута
  const handleRouteClick = () => {
    // Можно открыть Google Maps с маршрутом
    ...
    <div className="py-20 px-4 bg-gray-50 bg-gradient-to-br from-indigo-50 to-pink-50">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8 rounded-3xl overflow-hidden shadow-xl">
          {/* Map Container - Интерактивная карта с фиксированным маркером */}
          <div 
            ref={mapRef}
          ...
          >
            {/* Интерактивная карта (можно перемещать) */}
          ...
          <div className="bg-white p-8 md:p-10 rounded-xl flex flex-col justify-between shadow-lg border border-gray-100">
            ...
            <div className="flex flex-col space-y-6 mb-8">
              {/* Phone - теперь кликабельный на всю площадь */}
              <a 
              ...
              >
                ...
                <div className="flex flex-col">
                  <span className="text-sm text-gray-500 mb-1">Телефон</span>
              ...
              <div className="flex items-center space-x-4 p-3 rounded-xl transition-all duration-300 hover:bg-indigo-50">
                ...
                <div className="flex flex-col">
                  <span className="text-sm text-gray-500 mb-1">Адрес</span>
                  <span className="text-gray-800 font-medium">
                    GQX5+HWF, хиёбони Қаробоев, Душанбе
                  </span>
                </div>
              </div>
            ...
            {/* CTA Buttons - теперь с добавленной функциональностью звонка */}
        ...
        {/* Mobile Call Button - Появляется только на мобильных устройствах */}
        {isMobile && (
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center space-y-2 sm:space-y-0 sm:space-x-3 mt-8 p-4 bg-white rounded-xl shadow-lg border border-gray-100 max-w-max mx-auto">
          ...
          <div className="flex flex-wrap gap-2 justify-center sm:justify-start">
            <span className="font-semibold text-gray-800">Часы работы:</span>
