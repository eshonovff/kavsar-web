...
const About = () => {
  ...
  // Достижения
  const achievements = [
    { icon: <Users className="w-10 h-10" />, number: "500+", text: t("about.achievements.graduates") },
    { icon: <Award className="w-10 h-10" />, number: "20+", text: t("about.achievements.programs") },
    { icon: <Award className="w-10 h-10" />, number: "95%", text: t("about.achievements.recommend") },
    { icon: <Award className="w-10 h-10" />, number: "3+", text: t("about.achievements.experience") }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100 text-gray-800">
      ...
      <section className="py-20 relative">
        <div className="container mx-auto px-4 max-w-[1500px] relative">
          ...
          <div className="text-lg md:text-xl text-gray-700 mb-12">
            <p>
              {t("about.intro.paragraph1")}
            </p>
            <br />
            <p>
              {t("about.intro.paragraph2")} <strong>{t("about.intro.specialties")}</strong> {t("about.intro.paragraph2End")}
            </p>
            <br />
            <p>
            ...
            <br />
            <p>
              📚 {t("about.intro.final1")}, 🌍 {t("about.intro.final2")} ✨ {t("about.intro.final3")}
              <br />
